...
Api admin state is deprecated from version 5 and removed in version 6. We recommend using the new [Environment Import & Export](../../../../../how-to/how-to-environment-import-export.mdx).
