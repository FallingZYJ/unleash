...
If you are currently self-hosting Proxy, see our [Edge migration guide](https://docs.getunleash.io/unleash-edge/migrate-from-proxy) for a guide on how to migrate.
